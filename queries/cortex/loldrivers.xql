...
| fields _time, agent_hostname, agent_id, event_type, event_sub_type,
         ...
         actor_process_os_pid, actor_process_is_special, actor_process_instance_id,
         actor_process_causality_id, actor_causality_id, actor_primary_username,
         ...
         causality_actor_process_is_special, causality_actor_process_instance_id,
         causality_actor_process_causality_id, causality_actor_causality_id,
